...
ALLOWED_HOSTS = [
    ...
    "css-ra-vmanage-nprd.com-att-one.svc.cluster.local",
    "css-ra-vmanage-prod.com-att-one.svc.cluster.local"
]
...
MIDDLEWARE = [
    ...
    # "vmanage_app.middleware.auth.AAFAuthorization"
]
...
WSGI_APPLICATION = 'vmanage_app.wsgi.application'
...
DATABASES = {
    "default": {
        ...
        "NAME": "vmanage" if not UNITTEST else "unittest"
    }
}
