...
# This is a good practice to keep the secrets out of the code
...
ALLOWED_HOSTS = [
    # Internal Cluster Calls for Heartbeat
    os.environ.get('POD_IP'),
    os.environ.get('HOST_IP'),
    # Local Development Host Whitelist
    "local.att.com",
    # Actual Host Whitelist
    "selfservice.dev.att.com",
    "selfservice.web.att.com",
    # Internal Cluster Calls Host Whitelist
    "css-data-aggregator-nprd.com-att-one.svc.cluster.local",
    "css-data-aggregator-prod.com-att-one.svc.cluster.local"
]
